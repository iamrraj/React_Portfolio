...
<section id="fact11p"  class="wow fadeIn">
    ...
    <div class="col">
      ...
      <h4 class="count-text ">Our Customer</h4>
    </div>
	        </div>
              <div class="col">
               <div class="counter">
      <i class="fa fa-bug fa-2x text-success"></i>
      <h2 class="timer count-title count-number" data-to="4" data-speed="500"> </h2>
      <h4 class="count-text ">Hackathon</h4>
    </div>
              </div>
              <div class="col">
                  <div class="counter">
      ...
      <h4 class="count-text ">Project Completed</h4>
    </div></div>
              <div class="col">
              <div class="counter" >
      <i class="fa fa-coffee fa-2x text-success"></i>
      <h2 class="timer count-title count-number" data-to="53" data-speed="1500"> </h2>
      <h5 class="count-text ">Coffee With Clients</h5>
    </div>
              </div>
         </div>
         ...
         <br></br>
    <div className="lol">
    <button class="btn btn-success btn-large bth text-center animated fadeInLeft delay-4s " id="button" > <a href=" " class="text-center hww"  target="_blank" >
    <i class="fa fa-eye animated fadeInLeft delay-5s"></i>  View Cv</a></button>
    </div>
